...
export async function createOrder(data) {
  ...
  const key_id = process.env.RAZORPAY_KEY_ID || process.env.VITE_RAZORPAY_KEY_ID || 'rzp_test_TPI18kH1w67MI2';
  const key_secret = process.env.RAZORPAY_KEY_SECRET || 'tJ3uCQJG5MF7zV1SYl9cvNDj';
